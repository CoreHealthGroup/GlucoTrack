 ...
 *
 * Abstract:
 * The following file lists and defines UUIDs related
 * to the GlucoWatch. The UUIDs are specific to the 
 * GlucoWatch hardware (TI CC2650 MCU). Please see the
 * following document for additional details:
 *
 * CC2650UUIDList.pdf
...
#ifndef UUIDDefines_h
#define UUIDDefines_h

#define GLUCOWATCH_CC2650_CPU_MAIN_UUID @"F0005555-0451-4000-B000-000000000000"

#define GLUCOWATCH_BLOOD_GLUCOSE_SERVICE_UUID @"0000FFF1-0000-1000-8000-00805f9b34fb"
